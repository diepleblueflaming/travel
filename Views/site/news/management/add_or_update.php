<div class="col-sm-12 news">
    <div class="panel panel-primary col-sm-8 col-sm-offset-2" id="main-content">
        ...
        <div class="row panel-footer">
            <input class="btn btn-success" name="btn-submit" id="btn-submit" type="submit" value="<?=isset($news) ? "Cập Nhật" : "Thêm Mới" ?>" form="forms">
